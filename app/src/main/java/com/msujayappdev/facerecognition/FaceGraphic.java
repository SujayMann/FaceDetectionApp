...
public class FaceGraphic extends GraphicOverlay.Graphic {
  ...
  OnFaceDetectedListener onFaceDetectedListener;
  FaceGraphic(GraphicOverlay overlay, Face face, OnFaceDetectedListener onFaceDetectedListener) {
    super(overlay);

    this.face = face;
    this.onFaceDetectedListener = onFaceDetectedListener;
    final int selectedColor = Color.LTGRAY;
  ...
  public void draw(Canvas canvas) {
    Face face = this.face;
    if (face == null) {
      onFaceDetectedListener.onFaceDetected(false);
      return;
    }
